...
public class BookService {
    ...
    public void searchBySrNo(Connection conn) throws SQLException {
        ...
        Book book = dao.getBooksByarno(conn, srNo);

        if (book != null) {
            System.out.println("=== Book Details ===");
            System.out.println("Sr No : " + book.getarNo() + " Book Name: " + book.getBookName() + " Author Name: "
                    + book.getAuthorName());
        } else {
    ...
    public void checkOutBook(Connection conn) throws SQLException {
        ...
        Book book = bookDao.getBooksByarno(conn, sNo);
